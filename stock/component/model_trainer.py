...
from stock.util.util import load_numpy_array_data,save_object,load_object
from stock.entity.model_factory import MetricInfoArtifact, ModelFactory,GridSearchedBestModel
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self)->ModelTrainerArtifact:
        try:
            ...
            stock_model = stockEstimatorModel(preprocessing_object=preprocessing_obj,trained_model_object=model_object)
            logging.info(f"Saving model at path: {trained_model_file_path}")
            save_object(file_path=trained_model_file_path,obj=stock_model)
