...
from stock.util.util import read_yaml_file, save_object, save_numpy_array_data, load_data
import pandas as pd
...
class DataTransformation:
    ...
    def get_data_transformer_object(self)->ColumnTransformer:
        try:
            ...
            logging.info(f'pipeline established: {pipeline}')

            preprocessing =ColumnTransformer([
                ('pipeline', pipeline, dataset_columns) ])
